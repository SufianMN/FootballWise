...
class FeatureBuilderService:
    ...
    def load_data(self):
        print("Loading Feature Builder data...")
    ...
    def build_match_features(self, home_team_id, away_team_id, feature_columns):
        ...
        home_features = self.build_latest_team_features(home_team_id, "home", feature_columns)
        away_features = self.build_latest_team_features(away_team_id, "away", feature_columns)
        h2h_features = self.build_h2h_features(home_team_id, away_team_id, feature_columns)
